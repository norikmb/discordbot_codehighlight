...
client.on("message", function (message) {
    ...
    if (message.content.startsWith('https://github.com/')) {
        ...
        var newurl_1 = url.replace(/^(.*\/\/github.com\/.+\/.+\/)blob(\/.+)$/i, '$1raw$2');
        var paragraph_1 = url.split('#');
        if (paragraph_1[1] != null) {
            console.log('Where you want to display is existing.');
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                var response, sendtext, body, lines, fileType, LineNumber, begin, end, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4 /*yield*/, node_fetch_1["default"](newurl_1)];
                        case 1:
                            response = _a.sent();
                            sendtext = '';
                        ...
                        case 2:
                            body = _a.sent();
                            lines = body.split('\n');
                            fileType = paragraph_1[0].split('/').slice(-1)[0].split('.').slice(-1)[0];
